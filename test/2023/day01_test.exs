defmodule AdventOfCode.Solutions.Y23.Day01Test do
  ...
  alias AdventOfCode.Solutions.Y23.Day01, as: Solution, warn: false
  ...
  #
  #     mix test test/2023/day01_test.exs
  #
  # To run the solution
  #
  ...
  #
  #     # returns {:ok, "priv/input/2023/day-01-mysuffix.inp"}
  #     {:ok, path} = Input.resolve(2023, 1, "mysuffix")
  #
  # Good luck!
