defmodule AdventOfCode.Solutions.Y23.Day04Test do
  ...
  alias AdventOfCode.Solutions.Y23.Day04, as: Solution, warn: false
  ...
  #
  #     mix test test/2023/day04_test.exs
  #
  # To run the solution
  #
  ...
  #
  #     # returns {:ok, "priv/input/2023/day-04-mysuffix.inp"}
  #     {:ok, path} = Input.resolve(2023, 4, "mysuffix")
  #
  # Good luck!
